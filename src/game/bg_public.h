...
#define MOD_VERSION "2.3.0_th_0.2"
#endif
#endif
...
static const struct Manual commandManuals[] = {
	...
	{ "ban",          "!ban [player] [(optional) seconds] [(optional) reason]",                                                                                                                            "Bans target player from server."                                                    },
...
//    {"deleteuser", "!deleteuser -id [user id]", "Deletes a user based on ID."},
	...
	{ "edituser",     "!edituser [id] -cmds [personal commands] -title [personal title] -greeting [personal greeting] -clear [switch]\n",
...
//	{ "listcmds",     "!listcmds",                                                                                                                                                                      "Lists all commands or prints a command manual."                                     },
	...
	{ "listusernames","!listusernames [id]",                                                                                                                                                            "Lists all usernames of specified user ID."                                          },
	...
	{ "mostplayed",   "!mostplayed [(optional) count]",                                                                                                                                                 "Prints the most played maps on the server."                                         },
	{ "moverscale",   "!moverscale [scale]",                                                                                                                                                            "Scales vehicle movement speed."                                                     },
	{ "mute",         "!mute [target]",                                                                                                                                                                 "Mutes target player."                                                               },
	{ "noclip",       "!noclip [(optional) target] [(optional) count]",                                                                                                                                 "Gives noclip to yourself or target player. Use count to specify how many times "
...
//    { "routemaker", "!routemaker [player]", "Makes target player the route maker." },
	...
	{ "spectate",     "!spectate [(optional) target]",                                                                                                                                                  "Puts yourself into spectators, optionally spectating targeted player."              },
	{ "tokens",       "!tokens [create e|m|h] [move] [delete] [delete e|m|h 1-6]",                                                                                                                      "Creates/deletes/moves a collectible token with given parameters. Move and delete "
